...
const Hero = () => {
 ...
 <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20">
    The ultimate hotel experience awaits you
  </p>
  <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
    Discover Your Perfect Gateway Destination
  </h1>
  <p className="text-lg md:text-xl font-light text-gray-200">
    Experience luxury, comfort, and convenience at our top-rated hotels.
  </p>
 <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>

            <div>
                <div className='flex items-center gap-2'>
                <img src={assets.calenderIcon} alt="Search Icon" className=" h-4 text-gray-800" />
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
                                  <img src={assets.searchIcon} alt="Search Icon" className=" h-4 text-gray-800" />
